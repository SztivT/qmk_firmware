...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    ...
    TD(DANCE_0),    MT(MOD_LALT, KC_H),KC_I,           MT(MOD_LSFT, KC_E),MT(MOD_LCTL, KC_A),KC_TRANSPARENT,                                 KC_P,           MT(MOD_LCTL, KC_D),MT(MOD_LSFT, KC_R),KC_S,           MT(MOD_LALT, KC_L),KC_Z,           
    KC_TAB,         KC_X,           KC_SCLN,        KC_DOT,         KC_COMMA,       KC_TRANSPARENT,                                 KC_B,           KC_C,           KC_M,           KC_F,           KC_V,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TO(5),          TD(DANCE_1),    KC_L,                                           KC_TRANSPARENT, KC_ENTER,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    LT(4,KC_SPACE), OSL(3),                                         OSL(2),         TD(DANCE_2)
  ),
  [1] = LAYOUT_voyager(
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_GRAVE,       KC_DLR,         KC_LPRN,        KC_RPRN,        KC_DQUO,        QK_LLCK,                                        KC_AT,          KC_RABK,        KC_MINUS,       KC_EQUAL,       KC_LABK,        KC_CIRC,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_QUOTE,       KC_TRANSPARENT,                                 KC_BSLS,        KC_PLUS,        KC_PIPE,        KC_AMPR,        KC_PERC,        KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_1,           KC_2,           KC_3,           KC_4,           KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_6,           KC_7,           KC_8,           KC_9,           QK_LLCK,        
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_voyager(
    ...
    DM_REC1,        KC_LEFT_ALT,    KC_TRANSPARENT, KC_LEFT_SHIFT,  KC_LEFT_CTRL,   DM_PLY1,                                        KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       QK_LLCK,        
    DM_RSTP,        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_INSERT,      KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_voyager(
    KC_TRANSPARENT, TD(DANCE_3),    KC_V,           TD(DANCE_4),    TD(DANCE_5),    KC_DQUO,                                        TD(DANCE_9),    KC_W,           KC_RBRC,        KC_LBRC,        KC_E,           KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_Z,           KC_X,           MT(MOD_LSFT, KC_P),MT(MOD_LCTL, KC_C),TD(DANCE_6),                                    TD(DANCE_10),   MT(MOD_LCTL, KC_T),MT(MOD_LSFT, KC_F),TD(DANCE_11),   KC_B,           KC_G,           
    KC_TRANSPARENT, KC_PERC,        KC_LABK,        KC_RABK,        TD(DANCE_7),    KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_LPRN,        KC_RCBR,        KC_LCBR,        KC_RPRN,        KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, TT(6),          TD(DANCE_8),    KC_TRANSPARENT,                                 KC_O,           KC_TRANSPARENT, TO(0),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [6] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 TD(DANCE_12),   TD(DANCE_13),   TD(DANCE_14),   TD(DANCE_15),   TD(DANCE_16),   KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
                                                    KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT
  ),
